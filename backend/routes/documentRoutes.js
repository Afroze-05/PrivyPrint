...
router.post(
  ...
  (req, res, next) => {
    ...
    console.log(
      "🔍 Upload Route Debug - req.headers:",
      Object.keys(req.headers),
    );
    console.log(
      "🔍 Upload Route Debug - Authorization header:",
  ...
  (req, res, next) => {
    ...
    console.log(
      "🔍 Upload Route Debug - req.user.role after auth:",
      req.user?.role,
    );
    next();
  },
  (req, res, next) => {
    ...
    console.log(
      "🔍 Upload Route Debug - Role check result:",
...
router.get(
  ...
  authMiddleware,
  requireRole("admin"),
  documentController.getPrintHistory,
);
...
router.get(
  ...
  authMiddleware,
  requireRole("admin"),
  documentController.getDailyRevenue,
);
...
router.get(
  ...
  authMiddleware,
  requireRole("admin"),
  documentController.getRealTimeStats,
);
...
router.get(
  ...
  authMiddleware,
  requireRole("admin"),
  documentController.getEarningsHistory,
);
